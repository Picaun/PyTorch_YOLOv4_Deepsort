...
"""
2023/3/26
此代码源自：https://zhuanlan.zhihu.com/p/350335237
我对其做出了略微修改
"""
...
parser.add_argument('--json_path', default='/coco/person_only/annotations/instances_train2017.json',type=str, help="input: coco format(json)")# 这里我直接改了默认地址
parser.add_argument('--save_path', default='/coco/person_only/labels/train2017', type=str, help="specify where to save the output dir of labels")# 因为我用python --save_path老是出错
