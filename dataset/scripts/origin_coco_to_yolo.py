...
parser.add_argument('--json_path', default='/coco/original_coco/annotations/instances_val2017.json',type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='/coco/original_coco/labels/val2017', type=str, help="specify where to save the output dir of labels")#这里我直接改了默认地址，因为我不会用python --save_path
